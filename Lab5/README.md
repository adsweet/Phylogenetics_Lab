...
Laboratory Exercise 2: ML Tree Inference
...
Follow the same steps to open your Bombus_tree_uf.treefile in FigTree. Save both files (LastName_Lab5_iqtree_bs.pdf and LastName_Lab5_iqtree_uf.pdf). 
...
Laboratory Exercise 3: Partitioned Analysis
